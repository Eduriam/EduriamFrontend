...
Feature: UC-35 Advertisement after finishing learning or review
  ...
  Scenario: Premium user completes learning without fullscreen advertisement
    ...
    When I click on the "continue-button" button
    Then I should be on the "review-page" page
    And I should not see the "advertisement-fullscreen-dialog" section

  Scenario: Premium user completes review without fullscreen advertisement
    Given I am a premium user
  ...
  Scenario: Premium user completes upcoming lesson from home without fullscreen advertisement
    Given I am a premium user
