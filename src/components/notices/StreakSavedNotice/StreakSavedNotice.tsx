...
import type { StreakSavedNotice as StreakSavedNoticeType } from "infrastructure/api/users/me/notices/Notices";
import useNotices from "infrastructure/services/NoticeProvider";

export interface StreakSavedNoticeProps {
  notice: StreakSavedNoticeType;
}
      ...
      <Stack spacing={3.5} alignItems="center" sx={{ width: "100%", mt: 8 }}>
        ...
        <Typography variant="body1" textAlign="center" sx={{ maxWidth: 273 }}>
          {t("notices.streakSavedDescription", {
            freezesLeft: notice.freezesLeft,
          })}
        </Typography>
      </Stack>
    </NoticeDialog>
